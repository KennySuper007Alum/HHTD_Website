...
const pauseMessages = [
  "科學博物館重現「騰雲號」！全球首座一比一真實尺寸模型，你敢來體驗嗎？", 
  "請小心前方街道上的汽車和摩托車。前面有紅白色的警示標誌，別忘了停下。駕駛時，也要注意路邊的紅線!", 
  "城市驚見「生存遊戲商店」！安全疑慮升級，居民震驚！你準備好了嗎?", 
  "請留意路上的白色廂型車和白色卡車。周圍有多輛摩托車和機車，也請特別小心。注意路上的雙黃線，不能穿越雙黃線超車或換到另一車道。", 
  "右前方ubike與旅店界的秘密聯盟，你覺得這是策略還是巧合呢?", 

  "你知道嗎，高雄中學是高雄市的一所知名學府，擁有豐富的學術歷史和文化遺產，另外我們前方的那個電話亭，它其實是高雄市街頭一個相當特別的景象，你是否也想使用看看呢？或許可以用電話問出年份呢！", 
  "請留意街上的銀色小型廂型車和綠色公車，以及騎黑色摩托車的男子。同時，注意交通標誌。在街上小心駕駛，避免其他車輛，並注意你的周圍，如建築物、旗幟和行人。", 
  "訊我們的前方有一家烤鴨店，地點就在愛河的附近，你會不會想要吃愛河特色的烤鴨呢？", 
  "請注意周圍的交通，特別是停在街上的車輛和附近駕駛的車輛。留意前方的綠燈，並小心可能從停車輛或建築物後面走出的行人。此外，別忘了留意任何表示可能有道路施工或障礙物。", 
  "聽說壽山動物園的動物會講話？你想去看看他們還有哪些秘密對話嗎?", 

  "元亨寺，蔚為台灣最大寺院的真實歷史，讓你有興趣了嗎？", 
  "請留意前方街道上的橙色錐筒，並在靠近它們時小心駕駛。也要與你前方的公車保持安全的距離。", 
  "右前方逃逸的狗狗成為熱議焦點! 壽山動物園的監管真的足夠嚴格嗎？", 
  "請小心駕駛，並注意路上的黃線。要留意前方的橙白色錐筒，以及街道上停著的黑白色車旁穿著黃綠色背心的男子。", 
  "中山大學熱門科系曝光！AI語言模型竟選此系就讀？你能猜到我想念甚麼嗎?", 

  "英國研究驚人發現曝光，參與童軍活動的孩童未來更容易成功？你覺得是這樣嗎?", 
  "請小心騎機車的人，並注意交通燈變成黃色。同時，也要留意任何可能提供重要資訊或警告的相關標誌。", 
  "跟你說一個珊瑚的冷知識， 由於珊瑚的結構和化學性質與人體骨骼極為相似，因此可以使用珊瑚做為替代骨移植。這樣的方法可以接受嗎？", 
  "留意街上的汽車和機踏板車，以及你左側騎自行車的男子。同時，請小心兩側停著的車輛和附近的行人。前方的交通燈是閃爍的紅燈，所以在接近時請做好停車的準備。", 
  "前方的牌樓是高雄港的地標之一，牌樓上的標語萬商雲集、航業海發，你有沒有發大財的感覺?", 

  "右前方是巨人的積木，引爆觀光熱潮的駁二新地標，僅以三點支撐，是不是覺得不可思議?", 
  "請注意路上的汽車和過馬路的行人，特別是穿白色大衣的女士。要留意交通標誌，例如帶有紅色三角形的白色標誌。在這城市街道上保持警覺，因為交通或行人的動向可能會突然改變。", 
  "請小心，因為前方有人騎摩托車。請注意路上的黃線並留意交通標誌。另外，如果公車後方的黃燈表示停車或轉彎，請減速慢行。", 
  "左前方是著名牛肉麵店，不禁讓我想到如果牛角麵包裡也沒牛角，牛肉麵真的需要牛肉嗎？你覺得需要嗎?", 
  "前方右手邊的大樓設計很特別，你覺得這些線條有代表什麼意義嗎，或是假如你是設計師，你會想設計何種外觀的大樓呢？", 

  "炎炎夏日，找不到遮陽的地方嗎？右前方的冰店的特色冰品是不錯的選擇，你想停下來嗎?", 
  "請小心，因為前方有人騎摩托車轉彎。請注意路上的黃線並留意交通標誌。", 
  "左前方是高雄文化中心，當前藝術市集包從麵包花藝到手工皂都有，你會期望在市集內看到什麼手工藝品呢?", 
  "保持警覺並與路上的汽車保持安全距離，特別是前方的黃色汽車。留意交通標誌，例如你右側的藍色街道標誌。", 
  "英國最新研究證實：定期在衛武營音樂廳聽音樂，對健康有好處？你覺得有那些好處?"
];
...
const sceneTimes = {
  "城市": {
      ...
      // endTimes: [104.134, 189.040, 274.030, 402.200, 512.630, 612.120]
  },
  "太空": {
      startTimes: [/*... your times for scene 2 */],
      // endTimes: [/*... your times for scene 2 */]
  }
};
...
// // 檢查影片時間是否到結束點
// const checkVideoEndTime = () => {
//   let endTimes = sceneTimes[currentScene].endTimes;

//   if (video.currentTime >= endTimes[entryCount]) {
//       video.pause();
...
const checkVideoTime = () => {
  ...
  if ((video.currentTime > nextPauseTime + 0.001 && Math.abs(video.currentTime - nextPauseTime) <= closeEnough)) {
      updateNextPauseTime(video.currentTime);
      streetMusic.pause();

      const messageIndex = pauseTimes.indexOf(nextPauseTime);
      const messageToShow = pauseMessages[messageIndex - 1];
